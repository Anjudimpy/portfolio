...
const Footer = () => {
  return (
    ...
    <div className=' relative text-red-600  animate-spin bg-yellow-300  -left-1  w-[6.5rem] h-[6.5rem] border border-t-2  rounded-full'>
        <div className='text-red-600   -left-1  w-[6.5rem] h-[6.5rem] border border-t-2  rounded-full'></div>
    </div>
...
<div className='group absolute flex md:-mt-[6.3rem] -mt-[5.4rem] -ml-1 items-center space-x-6'>
    <div className='md:w-[6rem] md:h-[6rem] w-[5rem] h-[5rem] flex items-center justify-center rounded-full bg-[#55e6a5]'>
...
<div className='group absolute -mt-[6rem] flex items-center space-x-6'>
    <div className='md:w-[6rem] md:h-[6rem] w-[5rem] h-[5rem] flex items-center justify-center rounded-full bg-[#55e6a5]'>
